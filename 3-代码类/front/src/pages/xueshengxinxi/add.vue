...
<div :style='{"padding":"20px 20px 40px","margin":"10px auto 0","borderColor":"#52b646","borderRadius":"12px","background":"#fff","borderWidth":"3px","width":"1200px","position":"relative","borderStyle":"solid dashed double double"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="出生年月" prop="chushengnianyue" >
              <el-date-picker
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="家庭住址" prop="jiatingzhuzhi">
            <el-input v-model="ruleForm.jiatingzhuzhi" 
                placeholder="家庭住址" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}'  label="报到状态" prop="baodaozhuangtai">
            <el-select v-model="ruleForm.baodaozhuangtai" placeholder="请选择报到状态"  >
              <el-option
                  v-for="(item,index) in baodaozhuangtaiOptions"
                  :key="index"
                  :label="item"
                  :value="item">
              </el-option>
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='baodaozhuangtai'){
              this.ruleForm.baodaozhuangtai = obj[o];
              this.ro.baodaozhuangtai = true;
              continue;
            }
            if(o=='beizhu'){
